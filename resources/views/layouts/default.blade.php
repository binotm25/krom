...
<a href="#" data-toggle="modal" data-target="#videoModal" data-theVideo="https://www.youtube.com/embed/1_bzaYi1r5E?rel=0&amp;showinfo=0" class="btn btn-default btn-md btn-watch temp-margin">WATCH VIDEO</a>   
</div>
<div class="col-md-3"></div>   
...
<div class="modal fade" id="videoModal" tabindex="-1" role="dialog" aria-labelledby="videoModal" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content cust-mod">
            <div class="modal-body">
                <button type="button mod-btn" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <div>
